...
<head>
    ...
    <link rel="stylesheet" href="<?php echo get_template_directory_uri(); ?>/assets/css/contact-us.css">
    <title>Contact Us | Bond Cleaning Service</title>
</head>
...
<body>
    ...
    <div class="main">
        <div class="main-child">
            <div class="left">
                ...
                <p>We're here to make your move stress-free with our 24/7 support. Whether you need to book a service or
                    have questions, our team is always available to assist you, any time of the day or night.</p>
                <div class="main-btns">
                    <a href="#faqs" class="">Frequently Asked Questions <i class="fas fa-arrow-right"></i></a>
                    <a href="#faqs" class="">All Course Pricing <i class="fas fa-arrow-right"></i></a>
                    <a href="#faqs" class="">Upcoming Online Courses <i class="fas fa-arrow-right"></i></a>
                </div>
                <h3><i class="fa fa-envelope"></i>hello@gmail.com</h3>
                <h3><i class="fa fa-phone"></i>+62 132 432 342</h3>
            </div>
            <div class="right">
                <h2>Contact us</h2>
                <p>Contact us for a quote, help or to join the team</p>
                <form action="">
                    <p class="frm-text">Get in touch</p>
                    <div class="mb-3">
                        <label for="yourname">Name</label>
                        <input type="text" class="form-control p-3" id="yourname" name="yourname"
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control p-3" id="message" name="message"
                            placeholder="Write you message..." required></textarea>
                    </div>
                    <div class="mb-3 d-flex justify-content-end">
                        <button type="submit" class="btn-submit p-3">Send a Message <i
        ...
        <div class="bcs-cta-child">
            ...
            <div class="bcs-cta-child-right">
                <form action="#" method="post" class="w-100">
                    <div class="mb-3">
                        <input type="text-name" id="fullname" name="fullname" class="form-control w-100 p-3"
                            placeholder="Your Name" required>
                    </div>
    ...
    <div class="bcs-bond-faqs" id="faqs">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            // Toggle menu icon based on checkbox state
            ...
            menuIcon.addEventListener('click', function () {
                ...
                updateMenuIcon(); // Update icon based on new checkbox state
            });
